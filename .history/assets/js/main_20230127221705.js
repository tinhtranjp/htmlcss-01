...
// window.addEventListener("load", feedbackSlider(I, A, T));
// window.addEventListener("load", feedbackSlider2(I, A, T));

function feedbackSlider(I, A, T) {
  const feedbackItem = document.querySelectorAll(I);
  const sliderAcition = document.querySelector(A);
  const tick = document.querySelectorAll(T);
...
function feedbackSlider2(I, A, T) {
  const feedbackItem = document.querySelectorAll(I);
  const sliderAcition = document.querySelector(A);
  const tick = document.querySelectorAll(T);
  const itemWidth = feedbackItem[0].offsetWidth;
